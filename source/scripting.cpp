...
EVT_DECLARE_USER_FUNC(loadStage7, 0)
//EVT_DECLARE_USER_FUNC(osReportLWZero, 0)

EVT_BEGIN(loadMsgFile)
  USER_FUNC(mod::loadStage7)
  RETURN()
EVT_END()
        ...
        CASE_SMALL(1000)
            ...
            ELSE()
                ...
                ELSE()
                    ...
                    USER_FUNC(spm::evt_msg::evt_msg_print_add_insert, 0, PTR("stg7_2_133_2_094"), LW(3), 4)
                    USER_FUNC(spm::an2_08::evt_rpg_mario_take_damage, 4, 0, LW(0))
                END_IF()
            END_IF()
        CASE_SMALL(2000)
            ...
            ELSE()
                ...
                ELSE()
                    RUN_CHILD_EVT(mod::marioRPGtakeDamage)
                    USER_FUNC(spm::an2_08::evt_rpg_calc_mario_damage, 0, LW(10))
                    USER_FUNC(spm::evt_msg::evt_msg_print_add_insert, 0, PTR("stg7_2_133_2_098"), LW(3), 6)
                    USER_FUNC(spm::an2_08::evt_rpg_mario_take_damage, 6, 0, LW(0))
                END_IF()
            END_IF()
        CASE_ETC()
...
USER_FUNC(spm::evt_mario::evt_mario_key_off, 0)
  ...
  EVT_BEGIN(mr_l_appear)
      ...
      END_INLINE()
      USER_FUNC(spm::evt_snd::evt_snd_sfxon_3d_player_character, PTR("SFX_P_V_MARIO_BIKKURI1"), PTR("SFX_P_V_PEACH_BIKKURI1"), PTR("SFX_P_V_KOOPA_BIKKURI1"), 0)
      ...
      USER_FUNC(spm::evt_npc::evt_npc_set_property, PTR("タマラ"), 14, PTR(&spm::sp4_13::mrLStartTribeAnimDefs))
      USER_FUNC(spm::evt_npc::evt_npc_set_anim, PTR("タマラ"), 0, 1)
      ADD(LW(0), 100)
      USER_FUNC(spm::evt_snd::evt_snd_sfxon_npc, PTR("SFX_P_LUIGI_JUMP1"), PTR("ルイージ"))
      USER_FUNC(spm::evt_npc::evt_npc_jump_to, PTR("ルイージ"), LW(0), 0, LW(2), FLOAT(80.0), 500)
      ...
      INLINE_EVT_ID(LW(10))
          ...
          DO(0)
              ADD(LW(0), 20)
              MOD(LW(0), 360)
              USER_FUNC(spm::evt_npc::func_800fe92c, PTR("タマラ"), 0, 10, 0)
      ...
      USER_FUNC(spm::evt_npc::evt_npc_set_unitwork, LW(3), 8, PTR(spm::sp4_13::brobot_appear))
