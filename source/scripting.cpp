...
EVT_BEGIN(attack)
    ...
    //USER_FUNC(spm::evt_ac::evt_ac_entry, PTR("ac"), 4) purely for testing, not actual gameplay
    //USER_FUNC(spm::evt_ac::evt_ac_return_results, PTR("ac"), LW(10))
    //USER_FUNC(spm::evt_ac::evt_ac_delete, PTR("ac"))
    //USER_FUNC(mod::osReportLW, LW(10))
...
SWITCH(LW(10))
    ...
    CASE_EQUAL(1) //Peach
        ...
        IF_EQUAL(LW(7), 3)
        USER_FUNC(spm::evt_snd::evt_snd_sfxon, PTR("SFX_I_RECOVER_HP_EFFECT_SMALL1"))
        USER_FUNC(spm::evt_msg::evt_msg_print_add, 0, PTR("peach_heal_success"))
...
USER_FUNC(spm::evt_mario::evt_mario_key_off, 0)
  ...
  USER_FUNC(mod::rpg_off)
  USER_FUNC(spm::evt_seq::evt_seq_set_seq, spm::seqdrv::SEQ_MAPCHANGE, PTR("sp4_14"), PTR("doa1_l"))
  WAIT_MSEC(500)
  ...
  END_IF()
  USER_FUNC(mod::rpg_off)
  USER_FUNC(spm::evt_door::evt_door_openable_onoff, 0)
  USER_FUNC(spm::evt_mario::evt_mario_key_on)
  RETURN()
  EVT_END()
