...
EVT_BEGIN(runEnemyTurn)
  IF_EQUAL(GSW(0), 170)
    RUN_CHILD_EVT(mod::brobotAttack)
  END_IF()
  RETURN()
EVT_END()
...
EVT_BEGIN(attack)
    ...
    INLINE_EVT()
      ...
      ADD(LW(10), 200)
      SUB(UW(3), 25)
      USER_FUNC(spm::evt_cam::evt_cam3d_evt_zoom_in, 0, LW(5), EVT_NULLPTR, UW(3), LW(5), EVT_NULLPTR, 200, 1000, 11)
      ADD(UW(3), 25)
    END_INLINE()
    USER_FUNC(spm::evt_mario::evt_mario_pos_change, LW(5), 0, FLOAT(180.0))
    SWITCH(LW(2))
        CASE_EQUAL(0)
          ADD(LW(5), 50)
          ADD(LW(12), 50)
    ...
    END_INLINE()
    USER_FUNC(spm::evt_mario::evt_mario_jump_to, LW(5), LW(6), LW(7), 60, 300)
    ADD(LW(5), 50)
    USER_FUNC(spm::evt_mario::evt_mario_face_coords, LW(5), LW(7))
    SUB(LW(5), 50)
    /*USER_FUNC(spm::evt_sub::evt_sub_random, 1000, LW(10))
    IF_SMALL(LW(10), 1)
        SET(LW(10), LW(2))
    ...
    ELSE()                USER_FUNC(spm::evt_snd::evt_snd_sfxon, PTR("SFX_E_ENEMY_DIE1"))
        ...
        ELSE()
            IF_FLAG(LW(0), 0x1)
                USER_FUNC(spm::an2_08::evt_rpg_status_remove, 0, LW(2), 1)
...
USER_FUNC(spm::evt_sub::evt_sub_random, 800, LW(7))
...
SWITCH(LW(10))
    ...
    CASE_EQUAL(3) //Luigi
        ...
        ELSE()
            ...
            ELSE()
                IF_FLAG(LW(0), 0x1)
                    USER_FUNC(spm::an2_08::evt_rpg_status_remove, 0, LW(4), 1)
...
END_SWITCH()
  ELSE()
    //USER_FUNC(spm::evt_msg::evt_msg_print_add, 0, PTR("no_fp"))
    ...
    ELSE()
      RUN_CHILD_EVT(mod::marioRPGtakeDamage)
      USER_FUNC(spm::an2_08::evt_rpg_mario_take_damage, 5, 0, LW(7))
    END_IF()
  END_IF()
SET(LW(0), 5)
RETURN()
...
EVT_BEGIN(pixls)
    SWITCH(LW(2))
        CASE_EQUAL(221) //Thoreau
            ...
            END_INLINE()
            USER_FUNC(spm::evt_sub::evt_sub_random, 1000, LW(9))
            USER_FUNC(mod::getFP, LW(5))
            IF_LARGE(LW(5), 0)
                USER_FUNC(mod::subtractFP, 1)
            ...
            IF_LARGE(LW(9), 900)
                ...
                IF_SMALL_EQUAL(LW(7), 500)
                  USER_FUNC(mod::addFP, 2)
                  USER_FUNC(spm::evt_msg::evt_msg_print_add, 0, PTR("grab_fp"))
                ELSE()
                  SET(LW(10), LW(4))
        ...
        CASE_OR(146)
            ...
            DO(3)
                ...
                IF_NOT_FLAG(LW(10), 0x8000)
                    ...
                    ELSE()
                        IF_FLAG(LW(0), 0x1)
                            USER_FUNC(spm::an2_08::evt_rpg_status_remove, 0, LW(5), 1)
...
EVT_BEGIN(setup_fight)
  ...
  USER_FUNC(spm::evt_mario::evt_mario_get_pos, LW(0), LW(1), LW(2))
  ADD(LW(0), 200)
  USER_FUNC(spm::evt_npc::evt_npc_entry, PTR("npc1"), PTR("e_kuribo"), 0)
  USER_FUNC(spm::evt_npc::evt_npc_set_position, PTR("npc1"), LW(0), LW(1), LW(2))
  USER_FUNC(spm::evt_npc::evt_npc_set_property, PTR("npc1"), 0xe, PTR(animsKuribo))
  USER_FUNC(spm::evt_npc::evt_npc_set_anim, PTR("npc1"), 0, 1)
  ADD(LW(0), 50)
  USER_FUNC(spm::evt_npc::evt_npc_entry, PTR("npc2"), PTR("e_kuribo"), 0)
  USER_FUNC(spm::evt_npc::evt_npc_set_position, PTR("npc2"), LW(0), LW(1), LW(2))
  USER_FUNC(spm::evt_npc::evt_npc_set_property, PTR("npc2"), 0xe, PTR(animsKuribo))
  USER_FUNC(spm::evt_npc::evt_npc_set_anim, PTR("npc2"), 0, 1)
  ADD(LW(0), 50)
  USER_FUNC(spm::evt_npc::evt_npc_entry, PTR("npc3"), PTR("e_kuribo"), 0)
  USER_FUNC(spm::evt_npc::evt_npc_set_position, PTR("npc3"), LW(0), LW(1), LW(2))
  USER_FUNC(spm::evt_npc::evt_npc_set_property, PTR("npc3"), 0xe, PTR(animsKuribo))
  USER_FUNC(spm::evt_npc::evt_npc_set_anim, PTR("npc3"), 0, 1)
  RETURN()
EVT_END()
...
INLINE_EVT()
    ...
    USER_FUNC(spm::an2_08::evt_rpg_enemy_take_damage, 1, 0, 0, LW(0))
