...
EVT_BEGIN(end_of_turn_stylish)
    ...
    IF_EQUAL(LW(11), 1)
        ...
        USER_FUNC(spm::evt_eff::evt_eff, 0, PTR("nice"), 0, LW(5), LW(6), LW(7), FLOAT(1.0), 0, 0, 0, 0, 0, 0, 0)
        SET(LW(5), UW(4))
        INLINE_EVT()
            SET(LW(11), 0)
        ...
        IF_EQUAL(LW(11), 1)
            ...
            USER_FUNC(spm::evt_eff::evt_eff, 0, PTR("nice"), 1, LW(5), LW(6), LW(7), FLOAT(1.0), 0, 0, 0, 0, 0, 0, 0)
            SET(LW(5), UW(4))
            INLINE_EVT()
                SET(LW(11), 0)
                SETF(LW(10), FLOAT(0.0))
...
EVT_BEGIN(pixls)
    ...
    SWITCH(LW(2))
        ...
        CASE_EQUAL(220) //Tippi
            USER_FUNC(spm::evt_msg::evt_msg_print_add, 1, PTR(tippi_fail))
    END_SWITCH()
    RUN_CHILD_EVT(runEnemyDeath)
    USER_FUNC(enable_disable_rpg_menu, 0)
    USER_FUNC(spm::evt_msg::evt_msg_continue)
