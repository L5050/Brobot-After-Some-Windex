...
s32 check_pressed_b_ac(spm::evtmgr::EvtEntry * evtEntry, bool firstRun) {
  ...
  s32 patchAsserts(spm::evtmgr::EvtEntry * evtEntry, bool firstRun) {
    writeWord(spm::evtmgr::evtEntryType, 0x80, 60000000);
    writeWord(spm::evtmgr::evtEntry, 0x7C, 60000000);
    writeWord(spm::evtmgr::evtChildEntry, 0x7C, 60000000);
    return 2;
  }

  EVT_DECLARE_USER_FUNC(check_pressed_b_ac, 0)
  EVT_DECLARE_USER_FUNC(patchAsserts, 0)
    ...
    USER_FUNC(spm::evt_npc::evt_npc_entry_from_template, 0, 44, 0, 0, 0, LW(10), EVT_NULLPTR)
...
LBL(1)
    USER_FUNC(check_pressed_b_ac)
    USER_FUNC(spm::evt_npc::evt_npc_tribe_agb_async, 130)
    USER_FUNC(spm::evt_npc::evt_npc_entry_from_template, 0, 130, 0, -100, 0, LW(10), EVT_NULLPTR)
    USER_FUNC(spm::evt_npc::evt_npc_set_anim, LW(10), 0, 1)
    USER_FUNC(spm::evt_npc::func_80107c38, LW(10), 0)
    USER_FUNC(spm::evt_npc::evt_npc_flag8_onoff, LW(10), 0, 8)
    USER_FUNC(spm::evt_npc::evt_npc_flag8_onoff, LW(10), 1, 65536)
...
USER_FUNC(spm::evt_npc::evt_npc_set_position, LW(10), FLOAT(0.0), LW(1), FLOAT(0.0))
    ...
    USER_FUNC(spm::evt_npc::evt_npc_wait_flip_finished, LW(10))
USER_FUNC(spm::evt_npc::evt_npc_restart_evt_id, LW(10))/*
    USER_FUNC(spm::evt_npc::evt_npc_tribe_agb_async, 196)
    USER_FUNC(spm::evt_npc::evt_npc_entry_from_template, 0, 196, 0, -100, 0, LW(10), EVT_NULLPTR)
    USER_FUNC(spm::evt_npc::evt_npc_set_anim, LW(10), 0, 1)
    USER_FUNC(spm::evt_npc::func_80107c38, LW(10), 0)
    USER_FUNC(spm::evt_npc::evt_npc_flip_to, LW(10), 1)
    USER_FUNC(spm::evt_npc::evt_npc_finish_flip_instant, LW(10))
...
USER_FUNC(spm::evt_npc::evt_npc_restart_evt_id, LW(10))
    ...
    USER_FUNC(spm::evt_npc::evt_npc_entry_from_template, 0, 288, 0, -100, 0, LW(10), EVT_NULLPTR)
    USER_FUNC(spm::evt_npc::evt_npc_set_anim, LW(10), 0, 1)
    USER_FUNC(spm::evt_npc::func_80107c38, LW(10), 0)
    USER_FUNC(spm::evt_npc::evt_npc_flag8_onoff, LW(10), 0, 8)
    USER_FUNC(spm::evt_npc::evt_npc_flag8_onoff, LW(10), 1, 65536)
...
USER_FUNC(spm::evt_npc::evt_npc_set_position, LW(10), FLOAT(0.0), LW(1), FLOAT(0.0))
    ...
    EVT_BEGIN(bonechillSucks)
        USER_FUNC(spm::evt_npc::evt_npc_set_unitwork, PTR("me"), 14, otherDeathScript)
    RETURN_FROM_CALL()
...
void bringle_main()
{
    ...
    evtpatch::hookEvt(spm::npcdrv::npcEnemyTemplates[189].unkScript6, 1, (spm::evtmgr::EvtScriptCode*)bonechillSucks);
