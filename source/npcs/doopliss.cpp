  ...
  EVT_BEGIN(doopliss_death)
    ...
    BROTHER_EVT_ID(LW(5))
      ...
      DO(0)
        ...
        USER_FUNC(evt_npc_set_rgba, PTR("npc2"), 255, LW(0), 0, 255)
        WAIT_FRM(1)
        IF_EQUAL(LW(1), 0)
        DO_BREAK()
        END_IF()
      ...
      DO(0)
        USER_FUNC(spm::evt_sub::evt_sub_intpl_msec_get_value)
        USER_FUNC(evt_npc_set_rgba, PTR("npc2"), LW(0), 255, 0, 255)
        WAIT_FRM(1)
        IF_EQUAL(LW(1), 0)
        DO_BREAK()
        END_IF()
      ...
      DO(0)
        USER_FUNC(spm::evt_sub::evt_sub_intpl_msec_get_value)
        USER_FUNC(evt_npc_set_rgba, PTR("npc2"), LW(0), 255, LW(0), 255)
        WAIT_FRM(1)
        IF_EQUAL(LW(1), 0)
        DO_BREAK()
        END_IF()
    ...
    USER_FUNC(evt_npc_set_anim, PTR("npc2"), 0, 1)
    USER_FUNC(evt_npc_set_rgba, PTR("npc2"), 252, 3, 53, 255)
